...
class primera_visita
{
    ...
    public function selectCurso(){
      ...
      WHERE p.id_persona=vap.id_persona AND p.id_persona=pe.id_persona AND vap.id_estado_vinculacion=1 AND vap.id_horas=800 AND pe.docente_supervisor=$id_supervisor AND pe.primera_supervision=0;";
