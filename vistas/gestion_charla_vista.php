              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" maxlength="100" id="txt_nombre_charla" name="txt_nombre_charla" onkeyup="mayus(this);" required>
                  </div>
                </div>
                ...
                <div class="col-sm-4">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="date" id="txt_fecha_valida" name="txt_fecha_valida" required>
                  </div>
                </div>
