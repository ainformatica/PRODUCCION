        ...
        <div class="row mb-2">
         ...
         <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active"><a >Actividades Finalizadas</a></li>
            <li class="breadcrumb-item active"><a href="../vistas/actividades_canceladas_cve_vista.php">Actividades Canceladas</a></li>
          </ol>
        </div>
...
<div  id="formularioregistros2">
            <form name="formulario2" id="formulario2" method="POST">
             <section><h5><b><i><p>CANCELACIÓN DE ACTIVIDAD </p></i></b></h5>
                ...
                <div class="card card-default">
                <div class="card-header bg-gradient-dark">
                  <h3 class="card-title">Motivo Cancelación</h3>
                  <div class="card-tools">
                    <button type="button" class="btn btn-tool" data-card-widget="collapse">
                      <i class="fas fa-minus"></i>
                    </button>
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <label>Motivo:</label>
                  <p><textarea class="form-control" placeholder="Escriba el por qué cancela la actividad" name="just_act" id="just_act" rows="8" required="" maxlength="300" value=""                                       
                                      onkeyup="Card(event, this)"> </textarea></p>
                </div>
                </div>
                </div>
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <button class="btn btn-primary pull-right" type="submit" id="btnGuardar2"><i class="fa fa-check"></i> Cancelar Actividad</button>
                  <button class="btn btn-danger pull-right" onclick="cancelarform()" type="button"><i class="fa fa-arrow-circle-left"></i> Salir</button>
                </div>
              </form>
            </div>
