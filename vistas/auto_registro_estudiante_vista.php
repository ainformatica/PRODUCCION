        ...
        <form action="../Controlador/guardar_auto_registro_estudiantes_controlador.php" method="post">
          ...
          <!-- <div class="input-group mb-3">
            <div class="custom-file">
                <input type="file" accept="image/png,image/jpeg,image/jpg" class="custom-file-input" id="txt_foto" name="txt_foto">
                <label class="custom-file-label" for="exampleInputFile">Foto del Estudiante</label>
            </div>
          </div> -->
