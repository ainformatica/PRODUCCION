...
<div class="wrapper">
  ...
  <!-- ../vistas/registrar_solicitud_practica_vista.php -->
  <a id="solicitudpps" href="../vistas/registrar_solicitud_practica_vista.php " class="small-box-footer">
   Ir <i class="fas fa-arrow-circle-right"></i>
  </a>
  <input id="id_estudiante" type="hidden" value="<?php echo $_SESSION['id_usuario']?>">
  </div>
   <!-- /.info-box -->
  </div>
          <!-- /.col -->
  ...
  <a id="documentacion" href="../vistas/subida_informacion_estudiante_vista.php" class="small-box-footer">
    Ir <i class="fas fa-arrow-circle-right"></i>
  </a>
</div>
</div>
...
<script src="../js/charla/validarCharla.js"></script>
</body>
</html>